...
LISTA_SERVICIOS_GRAL = ["Ingreso APP Nequi", "Consulta de Saldo", "Envio Bancolombia a Nequi", 
"Envio Nequi a Bancolombia", "Envio Nequi a Nequi", "Envio a otros Bancos", "Generación de OTP Retiros", 
"Retiros Cajeros ATM", "Envio Bre-B", "Recepcion Bre-B", "Tarjeta Física", "Tarjeta Digital", 
"Recargas CB Bancolombia", "Retiros CB Bancolombia", "Recargas CB Nequi", "Retiros CB Nequi", 
"Pagos PSE", "Recargas PSE", "Apis", "Pagos de Creditos", "Pay Pal", "Remesas", 
"Servicios Armario - Recargas y Paquetes (operador Tigo)", 
"Servicios Armario - Recargas y Paquetes (operador Claro)", "Vinculación",
"Descarga App", "Descarga App GT", "Cierre de Cuenta",
"Vinculacion (Vinculacion liviana)", 
"Tarjeta", "Tarjeta Pismo",
...
"Envio Nequi a Bancolombia por QR",
"Envio Nequi a otros bancos GT - Deshabilitado",
...
"Recarga CB Nequi Punto Red", "Recarga CB Nequi PTM",
"Credito OAF (Originacion al frente)", "Credito desde boton Nequi",
"Experiencias digitales - Deshabilitado",
"Retiro CB Nequi PTM", "Retiro CB Nequi Punto Red", 
"Servicio PTM", "Consulta de movimientos", "Colchon",
"Consulta de Bolsillos", "Sobres - Bolsillos",
...
LISTA_PSE = ["Pagos PSE", "Recargas PSE","Ingreso APP Nequi", "Consulta de Saldo", "Envio Bancolombia a Nequi", 
"Envio Nequi a Bancolombia", "Envio Nequi a Nequi", "Envio a otros Bancos", "Generación de OTP Retiros", 
"Retiros Cajeros ATM", "Envio Bre-B", "Recepcion Bre-B", "Tarjeta Física", "Tarjeta Digital", 
"Recargas CB Bancolombia", "Retiros CB Bancolombia", "Recargas CB Nequi", "Retiros CB Nequi", 
 "Apis", "Pagos de Creditos", "Pay Pal", "Remesas", 
"Servicios Armario - Recargas y Paquetes (operador Tigo)", 
"Servicios Armario - Recargas y Paquetes (operador Claro)", "Vinculación",
"Descarga App", "Descarga App GT", "Cierre de Cuenta",
"Vinculacion (Vinculacion liviana)", 
...
for i in range(st.session_state[f'num_serv_{tipo}']):
    ...
    with c2:
        ...
        elif tipo == "pse": cur_list = LISTA_PSE
